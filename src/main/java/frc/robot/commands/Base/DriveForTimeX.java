...
public class DriveForTimeX extends Command {
...
//   private PIDController rotationCorrectionPID;
  ...
  public DriveForTimeX(Base base, double initialSpeed, double time) {
    this.base = base;
  ...
  @Override
  public void execute() {
    base.drive(speed, 0, 0, true, KPhysicalMaxDriveSpeedMPS * base.getDriveSpeedFactor(), KBaseRotMaxPercent * base.getRotSpeedFactor());
